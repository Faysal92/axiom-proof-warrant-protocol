...
**Status:** Draft v0.1.5 / RFC Candidate  
...
**Reference Kernel:** Deterministic Python implementation  
...
AXIOM v0.1.5 is evidence-first.
...
## 30. Current Reference Implementation: v0.1.5
...
v0.1.5 includes a minimal FastAPI control plane.
